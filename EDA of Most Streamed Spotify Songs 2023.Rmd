...
We will be getting our hands dirty with a ton of data from the "[Most Streamed Spotify Songs 2023](https://www.kaggle.com/datasets/nelgiriyewithana/top-spotify-songs-2023/data)" data set I retrieved from the Kaggle website. We are especially going to focus on the energy quality in the music, which is described by the publisher as the perceived energy level of the song. The following are going to be answered and explored in our analysis:
